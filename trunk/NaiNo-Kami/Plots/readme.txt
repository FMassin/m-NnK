...
================================
-run_plot_NNK.sh (shell script run to temporarily set environment variables and execute 
 the application)
   -to run the shell script, type
   
       ./run_plot_NNK.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v714, run the shell script as:
       ...
       ./run_plot_NNK.sh /mathworks/home/application/R2010a/v714
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_plot_NNK.sh /mathworks/devel/application/matlab
-MCRInstaller.dmg 
   -include when building component by selecting "include MCR" option 
    in deploytool
-The Macintosh bundle directory structure plot_NNK.app 
   -this can be gathered up using the zip command 
    zip -r plot_NNK.zip plot_NNK.app
    or the tar command 
    tar -cvf plot_NNK.tar plot_NNK.app
-This readme file 
    ...
    Mac                     DYLD_LIBRARY_PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_plot_NNK.sh 
