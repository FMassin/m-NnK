...
disp('Attention !!!!!!!!!! NNK_takeparams.m : seuilcluster = 0.9 ;                  %');pause
...
stamaitre=[stamaitre ; 'loh']; % 
%===============================%%%%%% size(stamaitre,1) >= 2*ncorrel !!
% Paths                              %  
pathtowfs = '/Users/fredmassin/PostDoc_Utah/Results/Teton/NNK-Teton-loh-0.9/dtec' ; 
path2dtb = '/Users/fredmassin/PostDoc_Utah/Results/Teton/NNK-Teton-loh-0.9' ;   
netcode = 'WY' ;                     % specifiy network code UUSS-YVO:'WY' | OVPF:'PF' | Undervolc:'YA'
%====================================%
% To input your picks                %%%%%%%%
pathtomanualinp = '/Users/fredmassin/PostDoc_Utah/Results/Teton/NNK-Teton-0.9/inp' ;% AGATHE!!!!!!!!!!!!
inpextension = '.inp' ;                     %
