function [S1,D1,R1,S2,D2,R2,leplan1,leplan2,obj,T,P,FP1,FP2] = drawplan(diameter,lon,lat,alt,strike,dip,rake,colored,ax,cas,noslip,coupe,scales)
...
if cas == 1 | cas == 3     % plan auxiliaire 1
    %PLAN0 = surf(x, y, z, c) ;
    PLAN0 = fill3(x, y, z, C,'EdgeColor','k');
    ...
    leplan1(1:5,3) = get(FP1,'XData') ;
    leplan1(1:5,2) = get(FP1,'YData') ;
    leplan1(1:5,3) = get(FP1,'ZData') ;
    
    stretch(FP1,scales,[lon,lat,alt])
...
if cas == 2 | cas == 3          % plan auxiliaire 2
    ...
    leplan2(1:5,1) = get(FP2,'XData') ;
    leplan2(1:5,2) = get(FP2,'YData') ;
    leplan2(1:5,3) = get(FP2,'ZData') ;
    
    
    stretch(FP2,scales,[lon,lat,alt])
