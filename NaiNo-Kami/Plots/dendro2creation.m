function [ax,ploted,hlegend]=dendro2creation

global clust a dates1 cumnums
if exist('a','var') == 0 ; a = gca ; end 

% n eruptions %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cd /Users/fredmassin/PostDoc_Utah/Datas/eruptions
[eruption]=Perkins_n_Nash_2002;
cd /Users/fredmassin/PostDoc_Utah/Processes/NaiNoKami_2/Plots
...
legend(fortimeplot,'Earthquakes','Clusters','Eruptions','location','SouthEast')
axis image
...
figure;dimlessTempNFlux([alpEQ alpCLST alpERUP],[mugEQ mugCLST mugERUP],[0 0 1 ; 0.7 0.7 0.7 ; 0 1 0]);